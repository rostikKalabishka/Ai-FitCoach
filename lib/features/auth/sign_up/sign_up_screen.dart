                    ...
                    children: [
                      ...
                      _buildField(
                        ...
                        CustomTextfield(
                          ...
                          validator: (val) => FormValidators.usernameValidator(val),
                        ),
                      ),
                      _buildField(
                        context,
                      ...
                      _buildField(
                        ...
                        CustomTextfield(
                          ...
                          suffixIcon: IconButton(
                            onPressed: () {
                              setState(() {
                                obscuredConfirmedPassword = !obscuredConfirmedPassword;
                              });
                            },
                            color: theme.colorScheme.primary,
                            icon: Icon(obscuredConfirmedPassword ? Icons.visibility : Icons.visibility_off),
                          ),
                        ),
                      ),
                      const Spacer(),
